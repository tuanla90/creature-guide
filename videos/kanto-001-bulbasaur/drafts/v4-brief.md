...
**Earth comparisons already checked** (🔬), which you may use freely: frogs drink through a patch of
belly skin · algae inside coral tissue recycle the host's waste · lichen as fungus + alga · mistletoe
slowly draining its host · a horse's tail swatting flies · an elephant's trunk (grasping, caressing,
striking) · lizards basking before they can run · agave putting its whole life into one flowering and
then dying · young sunflowers tracking the sun, mature ones fixed facing east · elephants and giant
tortoises: carrying weight turns legs into pillars · **peppered moths: pale moths on soot-darkened
bark were eaten by birds far more often** (new, for beat 08).
...
| 07 | 38s | ~87 | They do touch, just not lying down. 👁 Two vines come out from under the bulbs, meet in the air, curl around each other for a few seconds, let go. He watched for twenty minutes and wrote nothing. 🔬 Not a whip: closer to an elephant's trunk, to hold, to touch, to greet. And to scratch: the back is a blind spot for a short-necked, four-legged animal. 👁 K-01 flicks a vine over its back and knocks off a caterpillar, 🔬 exactly like a horse's tail at a horsefly. |
...
| 11 | 52s | ~119 | People who have raised them for years say every species has its own nature, and this one has two. 👁/📖 First, which he measured before anyone told him: at harsh noon K-01 covers the same stretch **almost twice as fast** as in shade (he timed it). 🔬 Lizards bask before they can run; a sun-driven machine runs harder the harsher the sun. 📖 Second, seen only in the yard, and it bothers him more than it impresses him: a badly hurt animal suddenly hits harder. His reading: it isn't stronger, it is spending the last of the reserve, once. 🔬 Agave: decades stored for one flowering, then death. |
...
- `who`: `none` · `bulbasaur` · `bulbasaur:K-01` · `bulbasaur:K-04` · `ivysaur` · `ivysaur:K-01` ·
  `venusaur:female` · `fearow` · `real:<Earth species>` · `anatomy:<species>` (x-ray style) — join with
